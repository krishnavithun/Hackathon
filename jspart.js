...
var repolinks = document.querySelector(".displayrepo");
var clientid = "Iv1.f4be9b4ec47d5290";
var clientsecret = "5072375649143a9e4e23eb99beb6581498f4c46c";
var fetchUsers = function (user) { return __awaiter(_this, void 0, void 0, function () {
    var apicall, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://api.github.com/users/" + user + "?clientid=" + clientid + "&clientsecret=" + clientsecret)];
            case 1:
                apicall = _a.sent();
...
var showData = function () {
    fetchUsers(inputValue.value).then(function (res) {
        console.log(res);
        ...
        app.forEach(function (ele) {
            output += "\n          \n          <style>\n          #marginTop {\n            margin-top: 20px !important;\n            margin-bottom: 0px;\n          }\n          </style>\n    \n          <div class=\"container\">\n          <ul class=\"collection\">\n          <li class=\"collection-item avatar\">\n          <img src=\"" + ele.owner.avatar_url + "\" class=\"circle\">\n          <a href=\"" + ele.html_url + "\" target=\"_blank\" > <span class=\"title\">" + ele.name + "</span> </a>\n          <p>" + ele.description + "</p>\n           <a href=\"#!\" class=\"secondary-content\"><i class=\"material-icons\">grade</i>" + ele.stargazers_count + "</a>\n           <div id=\"marginTop\" class=\"row\">\n          <div class=\"col s1\"><span class=\"new badge\">" + ele.language + "</span></div>\n          <div class=\"col s6\"><span class=\"badge\">Updated: " + ele.updated_at + "</span></div>\n    \n        </div>\n           </li>\n           </ul>\n           </div>\n          \n          ";
        });
        repolinks.innerHTML = output;
    });
};
